this.pov_undead_pain_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "[color=#5c0101]Destabilised[/color]";
	...
	{
		return "While this character cannot feel sever pain from their recent Injury, the magic keeping them togeather has been severely destabilised, and will need time to recover, resulting in reduced speed and increased fragility. Stacking. \n\n Will wear off in [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] turn(s).";
	}
