this.sickness2_injury <- this.inherit("scripts/skills/injury/injury", {
	m = {},
	function create()
	{
		this.injury.create();
		this.m.ID = "injury.sickness2";
		...
		this.m.Icon = "ui/injury/injury_mutation_aftermath.png";
		this.m.IconMini = "injury_mutation_aftermath_mini";
