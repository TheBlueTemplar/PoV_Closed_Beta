this.emperor_skull_item <- this.inherit("scripts/items/accessory/accessory", {
	m = {},
	function create()
	{
		this.accessory.create();
		this.m.ID = "emperor_skull_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/corpse_skeleton4.png";
	...
	function getTooltip()
	{
		...
		result.push({
				id = 3,
				type = "image",
				image = "consumables/corpse_skeleton4.png",
		});
	...
	function onEquip()
	{
		...
		local skill = this.new("scripts/skills/effects/emperor_effect");
		skill.setItem(this);
		this.addSkill(skill);
