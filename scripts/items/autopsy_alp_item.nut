this.autopsy_alp_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_alp_item";
		this.m.Name = "Alp Autopsy";
		this.m.Description = "Attempt to extract useful items from this alp corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_alp.png";
		this.m.Value = 500;
	}
