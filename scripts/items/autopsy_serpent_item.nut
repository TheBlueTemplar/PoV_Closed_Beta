this.autopsy_serpent_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_serpent_item";
		this.m.Name = "Serpent Autopsy";
		this.m.Description = "Attempt to extract useful items from this serpent corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_serpent.png";
		this.m.Value = 500;
	}
