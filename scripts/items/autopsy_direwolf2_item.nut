this.autopsy_direwolf2_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_direwolf2_item";
		this.m.Name = "White Direwolf Autopsy";
		this.m.Description = "Attempt to extract useful items from this white direwolf corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_direwolf2.png";
		this.m.Value = 500;
	}
