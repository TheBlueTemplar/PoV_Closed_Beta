this.autopsy_alp2_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_alp2_item";
		this.m.Name = "Demon Alp Autopsy";
		this.m.Description = "Attempt to extract useful items from this alp corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_alp2.png";
		this.m.Value = 500;
	}
