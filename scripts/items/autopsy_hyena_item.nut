this.autopsy_hyena_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_hyena_item";
		this.m.Name = "Hyena Autopsy";
		this.m.Description = "Attempt to extract useful items from this hyena corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_hyena.png";
		this.m.Value = 500;
	}
