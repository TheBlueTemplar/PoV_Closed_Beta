this.autopsy_schrat_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_schrat_item";
		this.m.Name = "Schrat Autopsy";
		this.m.Description = "Attempt to extract useful items from this schrat corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_schrat.png";
		this.m.Value = 500;
	}
