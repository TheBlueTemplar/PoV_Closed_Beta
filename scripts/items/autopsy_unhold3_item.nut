this.autopsy_unhold3_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_unhold3_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_unhold3.png";
		this.m.Value = 500;
	}
