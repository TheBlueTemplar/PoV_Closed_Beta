this.autopsy_ghoul_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_ghoul_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_ghoul.png";
		this.m.Value = 500;
	}
