this.whip_mace <- this.inherit("scripts/items/weapons/weapon", {
	m = {
		//StunChance = 20
	},
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/mace_whip_01.png";
		this.m.Icon = "weapons/melee/mace_whip_01_70x70.png";
		...
		this.m.ArmamentIcon = "icon_mace_whip";
		this.m.RangeMin = 1;
		this.m.RangeMax = 3;
		this.m.RangeIdeal = 3;
		this.m.Value = 3000;
