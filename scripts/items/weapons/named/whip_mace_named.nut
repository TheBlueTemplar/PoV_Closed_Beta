this.whip_mace_named <- this.inherit("scripts/items/weapons/named/named_weapon", {
	m = {
	...
	function create()
	{
		...
		this.m.ID = "weapon.whip_mace_named";
		...
		this.m.IconLarge = "weapons/melee/mace_whip_01_named.png";
		this.m.Icon = "weapons/melee/mace_whip_01_named_70x70.png";
		...
		this.m.ArmamentIcon = "icon_mace_whip_named";
		this.m.RangeMin = 1;
		this.m.RangeMax = 3;
		this.m.RangeIdeal = 3;
		this.m.Value = 4000;
