this.autopsy_goblin1_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.autopsy_goblin1_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/autopsy_goblin1.png";
		this.m.Value = 500;
	}
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = " Acquire goblin mutagen [color=" + this.Const.UI.Color.PositiveValue + "]10%[/color] chance."
		});
