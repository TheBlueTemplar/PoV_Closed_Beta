this.corpse_lindwurm_item <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.corpse_lindwurm";
		...
		this.m.Icon = "consumables/corpse_lindwurm.png";
		this.m.Value = 50;
		this.m.Amount = 50.0;
		...
		result.push({
				id = 3,
				type = "image",
				image = "consumables/enemy_lindwurm.png",
		});
