this.corpse_orc2_item <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.corpse_orc2";
		...
		this.m.Icon = "consumables/corpse_orc2.png";
		this.m.Value = 50;
		this.m.Amount = 50.0;
	...
	function getTooltip()
	{
		...
		result.push({
				id = 3,
				type = "image",
				image = "consumables/enemy_orc2.png",
		});
