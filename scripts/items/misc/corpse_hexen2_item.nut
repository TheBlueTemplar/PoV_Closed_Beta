this.corpse_hexen2_item <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.corpse_hexen2";
		this.m.Name = "Coven Leader Corpse";
		this.m.ItemType = this.Const.Items.ItemType.Misc;
		this.m.Description = "The coven leader is obiously not human. Every aspect of their appearance is demonic.  An anatomist may be able to extract useful materials from this corpse.";
		this.m.Icon = "consumables/corpse_hexe2.png";
		this.m.Value = 50;
		this.m.Amount = 50.0;
	...
	function getTooltip()
	{
		...
		result.push({
				id = 3,
				type = "image",
				image = "consumables/enemy_hexe2.png",
		});
