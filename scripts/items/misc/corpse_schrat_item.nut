this.corpse_schrat_item <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.corpse_schrat";
		...
		this.m.Icon = "consumables/corpse_schrat.png";
		this.m.Value = 50;
		this.m.Amount = 50.0;
	...
	function getTooltip()
		...
		result.push({
				id = 3,
				type = "image",
				image = "consumables/enemy_schrat.png",
		});
