::TLW.HooksMod.hook("scripts/entity/tactical/legend_kobold", function ( q )
{
	q.onInit = @(__original) function()
	{
		...
		{
			// Kobold for now drops goblin corpse XD
			this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(actor, ::TLW.Corpse.Goblin));
	  	}
