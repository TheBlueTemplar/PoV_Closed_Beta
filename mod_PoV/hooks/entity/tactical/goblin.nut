::TLW.HooksMod.hook("scripts/entity/tactical/goblin", function ( q )
{
	q.onInit = @(__original) function()
	{
		...
		if (!::MSU.isKindOf(this.actor, "player")) 
		{
			...
			case (this.isKindOf(this, "goblin_shaman")):
				this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(this.actor, ::TLW.Corpse.GoblinShaman));
				break;
			case (this.isKindOf(this, "goblin_leader")):
				this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(this.actor, ::TLW.Corpse.GoblinLeader));
				break;
			default:	//fallback
				this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(this.actor, ::TLW.Corpse.Goblin));
				break;
			}
	  	}
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			local possibleMutations = [1, 2, 3, 6, 7, 8, 9, 10, 11, 13, 14, 15, 16]	// Create a list of all possible mutations
			...
			switch (this.World.Assets.getCombatDifficulty())
			{
				...
				case this.Const.Difficulty.Legendary: mutationChance = 16; break
			}
