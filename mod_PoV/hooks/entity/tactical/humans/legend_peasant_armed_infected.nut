::TLW.HooksMod.hook("scripts/entity/tactical/humans/legend_peasant_armed_infected", function ( q ) {
	...
	q.onInit = @(__original) function()
	{
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			{
				case this.Const.Difficulty.Easy: mutationChance = 6; break
				case this.Const.Difficulty.Normal: mutationChance = 8; break
				case this.Const.Difficulty.Hard: mutationChance = 12; break
				case this.Const.Difficulty.Legendary: mutationChance = 24; break
			}
