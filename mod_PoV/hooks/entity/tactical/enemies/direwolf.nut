::TLW.HooksMod.hook("scripts/entity/tactical/enemies/direwolf", function ( q )
{
	q.onInit = @(__original) function()
	{
		...
		{
			this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(actor, ::TLW.Corpse.DirewolfGroup));
	  	}
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			::TLW.MutateEntity.mutate_entity(this.actor,::TLW.EnemyMutChance.Medium,::TLW.EnemyMut.Direwolf,false);
		}
