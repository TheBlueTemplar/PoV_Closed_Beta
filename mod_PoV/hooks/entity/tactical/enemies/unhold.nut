...
::TLW.HooksMod.hook("scripts/entity/tactical/enemies/unhold", function ( q )
{
	q.onInit = @(__original) function()
	{
		...
		{
			this.actor.m.OnDeathLootTable.push(::TLW.CorpseDrop.getCorpseDrop(actor, ::TLW.Corpse.Unhold));
	  	}
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			local possibleMutations = [2, 3, 4, 5, 6, 7, 8, 9, 10, 13, 14, 15, 16]	// Create a list of all possible mutations
