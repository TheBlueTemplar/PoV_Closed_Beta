::TLW.HooksMod.hook("scripts/entity/tactical/enemies/orc_young", function ( q )
{
	q.onInit = @(__original) function()
	{
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			local possibleMutations = [1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 13, 14, 15, 16]		// Create a list of all possible mutations

			// Chances Calculations
			switch (this.World.Assets.getCombatDifficulty())
			{
				case this.Const.Difficulty.Easy: mutationChance = 4; break
				case this.Const.Difficulty.Normal: mutationChance = 6; break
				case this.Const.Difficulty.Hard: mutationChance = 9; break
				case this.Const.Difficulty.Legendary: mutationChance = 18; break
			}
