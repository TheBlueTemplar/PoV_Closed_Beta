::TLW.HooksMod.hook("scripts/entity/tactical/enemies/legend_bandit_rabble_poacher", function ( q ) {
	...
	q.onInit = @(__original) function()
	{
		...
		if (::TLW.EnableEnemyMutation)
		{
			...
			{
				case this.Const.Difficulty.Easy: mutationChance = 3; break
				case this.Const.Difficulty.Normal: mutationChance = 5; break
				case this.Const.Difficulty.Hard: mutationChance = 8; break
